...
\textbf{Sākṣī} & ``The witness; the non-acting observer that records.'' & Advaita Vedānta & The \texttt{SakshiKeeperAgent} and the immutable JSON-lines audit log at \texttt{\textasciitilde{}/.cache/pratyaksha/audit.jsonl} (XDG-style cache path; survives plugin reinstall). Write-once-per-turn, read-only-next-turn. Model-invariant. & \citep{indich1980consciousness, fasching2009witness, ganeri2017concealed} \\
