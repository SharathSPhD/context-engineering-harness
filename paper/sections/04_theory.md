# Theoretical Foundations: Classical Indian Epistemology Mapped to LLM Context Engineering
...
## Pratyakṣa — direct perception as the harness's grounding pramāṇa
...
## Avacchedaka — qualifier-conditioned cognition as typed limitor
...
## Bādha — sublation as supersede-with-provenance
...
## Buddhi and Manas — the two-stage attend-then-judge gate
...
## Sākṣī — the witness as model-invariant audit frame
...
## Khyātivāda — six-class typology of error
...
## Saṃskāras and vāsanās — adaptive forgetting
