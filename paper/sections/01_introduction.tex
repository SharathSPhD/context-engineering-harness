...
\item
  \textbf{A documented origin story} (Section 3) showing how this work emerged from a TRIZ-style contradiction analysis of context engineering itself, with the \texttt{triz-engine} plugin's \texttt{log\_session\_entry} tool used as the audit trail. We argue this method --- \emph{named contradictions, named principles, named operationalizations} --- generalizes beyond the present paper.
\end{enumerate}
